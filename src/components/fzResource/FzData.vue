<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>仿真数据资源</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="dataList" border stripe>
        ...
        <el-table-column label="仿真数据名称" prop="dataName"></el-table-column>
        <el-table-column label="数据类型" prop="dataType"></el-table-column>
        <el-table-column label="数据格式" prop="dataFileType"></el-table-column>
        <el-table-column label="数据版本号" prop="dataVersion"></el-table-column>
        <el-table-column label="仿真任务关联" prop="dataMapTask"></el-table-column>
        <!-- <el-table-column
          label="镜像版本号"
          prop="mirrorVersion"
        ></el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="文件版本" prop="dataFileType">
          <el-input v-model="addForm.dataFileType"></el-input>
        </el-form-item>
        <el-form-item label="文件上传" prop="dataFile">
          <el-input type="file" v-model="addForm.dataFile"></el-input>
        </el-form-item>
      </el-form>
      <!-- 底部区域 -->
